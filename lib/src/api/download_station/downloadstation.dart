...
import 'ds_models.dart' as ds_model;
...
class Info {
  ...
  Future<Response<String>> getInfoRaw({int? version}) {
    final param = {
      ...
      'version':
          version ?? _parentApi._cntx.maxApiVersion(Syno.DownloadStation.Info),
      'method': 'getinfo',
    };

    final uri =
        _parentApi._cntx.buildUri(_parentApi.endpoint + endpoint, param);
    return _parentApi._cntx.c.getUri(uri);
  }

  Future<model.APIResponse<ds_model.DownloadStationInfoGetInfo>> getInfo(
      {int? version}) {
    return getInfoRaw(version: version).then((resp) {
      return model.APIResponse.fromJson(jsonDecode(resp.data!),
          (json) => ds_model.DownloadStationInfoGetInfo.fromJson(json));
    });
  }
  ...
  Future<model.APIResponse<ds_model.DownloadStationInfoGetConfig>> getConfig(
      {int? version}) {
    return getConfigRaw(version: version).then((resp) {
      return model.APIResponse.fromJson(jsonDecode(resp.data!),
          (json) => ds_model.DownloadStationInfoGetConfig.fromJson(json));
    });
  }
  ...
  Future<model.APIResponse<void>> setServerConfig(Map<String, String> config,
      {int? version}) {
...
class Schedule {
  ...
  Future<Response<String>> getConfigRaw({int? version}) {
    final param = {
      ...
      'version': version ??
          _parentApi._cntx.maxApiVersion(Syno.DownloadStation.Schedule),
      'method': 'getconfig',
    };
  ...
  Future<model.APIResponse<model.DownloadStationScheduleGetConfig>>
      scheduleGetConfig({int? version}) {
    return getConfigRaw(version: version).then((resp) {
      return model.APIResponse.fromJson(jsonDecode(resp.data!),
          (json) => model.DownloadStationScheduleGetConfig.fromJson(json));
    });
  }
  ...
  Future<model.APIResponse<void>> scheduleSetConfig(
...
class Task {
  ...
  Future<model.APIResponse<ds_model.ListTaskInfo>> list(
    ...
    return listRaw(
        ...
        .then((resp) {
      return model.APIResponse<ds_model.ListTaskInfo>.fromJson(
  ...
  Future<model.APIResponse<List<ds_model.DownloadStationTaskActionResponse>>>
      delete(List<String> ids, bool forceComplete, {int? version}) {
    return deleteRaw(ids, forceComplete, version: version).then((resp) {
      return model.APIResponse.fromJson(jsonDecode(resp.data!), _getFromJson);
    });
  }
  ...
  List<ds_model.DownloadStationTaskActionResponse> _getFromJson(
      dynamic json) {
    return (json as List<dynamic>)
        .map((e) => ds_model.DownloadStationTaskActionResponse.fromJson(e))
        .toList();
  }
}
...
class Statistic {
  ...
  Future<model.APIResponse<model.DownloadStationStatisticGetInfo>> getInfo(
      {int? version}) {
    return getInfoRaw(version: version).then((resp) {
      return model.APIResponse.fromJson(jsonDecode(resp.data!),
          (json) => model.DownloadStationStatisticGetInfo.fromJson(json));
    });
  }
}
...
class RSSSite {
  ...
  Future<model.APIResponse<model.DownloadStationRSSSiteList>> list(
      {int? offset, int? limit, int? version}) {
    return listRaw(offset: offset, limit: limit, version: version).then((resp) {
      return model.APIResponse.fromJson(jsonDecode(resp.data!),
          (data) => model.DownloadStationRSSSiteList.fromJson(data));
    });
  }
...
class RSSFeed {
  ...
  Future<model.APIResponse<model.DownloadStationRSSFeedList>> list(String id,
      {int? offset, int? limit, int? version}) {
    return listRaw(id, offset: offset, limit: limit, version: version)
        .then((resp) {
      return model.APIResponse.fromJson(jsonDecode(resp.data!),
          (data) => model.DownloadStationRSSFeedList.fromJson(data));
    });
  }
}
