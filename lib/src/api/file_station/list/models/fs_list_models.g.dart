...
FileStationSharedFolderList _$FileStationSharedFolderListFromJson(
    ...
    FileStationSharedFolderList(
      ...
      shares: (json['shares'] as List<dynamic>)
          .map((e) => FileStationDirectory.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
FileStationDirectory _$FileStationDirectoryFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$FileStationDirectoryToJson(
        FileStationDirectory instance) =>
    <String, dynamic>{
